					...
					<div class="scroller-inner">
						...
						<section>
							<form action="regAsistencia.php" method="POST">
								<table class="Asistencia">
									...
									<tbody>
										...
										<tr>
											...
											<td><input type="radio" name="<?php echo $row->cod_estudiante ?>" id="radios" <?php if($row->asistencia=="Asistencia") echo "checked";  else ?>  value="Asistencia" required=""></td>
											<td><input type="radio" name="<?php echo $row->cod_estudiante ?>" id="radios" <?php if($row->asistencia=="Falta") echo "checked";  else ?>  value="Falta" required=""></td>
										</tr>
										<?php
										}
										?>
								...
								<input type="submit" name="Modificar" value="Modificar" class="btnA">
							</form>
						</section>
						<?php
						}
