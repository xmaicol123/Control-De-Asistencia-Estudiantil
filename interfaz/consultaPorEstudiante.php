			...
			<div class="mp-pusher" id="mp-pusher">
				...
				<div class="scroller"><!-- this is for emulating position fixed of the nav -->
					<div class="scroller-inner">
						...
						<center>
						<section>
							<form method="POST" action="consultaPorEstudiante.php">
							<style type="text/css">
								.fechas
								{
									padding: 7px;
							...
							/*CODIGO DE GRUPO*/
							$reg=$obj->consultarEstudiante($cod_grupo);
							?>    
							<select name='txt_estudiante' id='txt_estudiante'/>
							<option value='0'>Seleccionar Estudiante</option>
							<?php
							while ($row = mysqli_fetch_object($reg))
							{?>
							<option value="<?php echo $row->cod_estudiante ?>"><?php echo $row->nombre_estudiante ?></option>
							<?php
							}
							echo "</select>";
							?>
						...
						<?php 
						include_once('../php/PhpregAsistencia.php');
						function buscarPorEstudiante()
						{
							$obj = new Asistencia();
							$cod_estudiante = $_POST['txt_estudiante'];
							if ($_POST['txt_cod_grupo']==true) {
								$cod_grupo = $_POST['txt_cod_grupo'];
							}
							else
							...
							$resultado=$obj->buscarPorEstudiante($cod_estudiante,$cod_grupo);
						...
						<table class="Asistencia" id="Asistencia">
							...
							<tbody>
								...
								echo "<h3>Total Asistencias: ";
								echo $asistencia;
								echo "</h3>";
								echo "<h3>Total Faltas: ";
								echo $falta;
								echo "</h3>";
								?>
							</tbody>
