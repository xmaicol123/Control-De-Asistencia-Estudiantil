										...
										<td>
											<div class="dropdown">
  											...
  											<div class="dropdown-content">
    											<a href="consultaPorFecha.php?setCodGrupo=<?php echo base64_encode($row->cod_grupo) ?>">Por Fechas</a>
    											<a href="consultaPorEstudiante.php?setCodGrupo=<?php echo base64_encode($row->cod_grupo) ?>">Por Estudiante</a>
    											<a href="consultaPorAsistencia.php?setCodGrupo=<?php echo base64_encode($row->cod_grupo) ?>">Por Asistencias</a>
    											<a href="consultaPorFalta.php?setCodGrupo=<?php echo base64_encode($row->cod_grupo) ?>">Por Faltas</a>
    											<a href="consultaPorDetalle.php?setCodGrupo=<?php echo base64_encode($row->cod_grupo) ?>">Por Detalles</a>
  											</div>
											</div> 
										</td>
									</tr>
